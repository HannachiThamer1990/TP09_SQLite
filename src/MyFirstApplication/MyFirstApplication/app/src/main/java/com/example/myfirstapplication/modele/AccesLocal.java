...
import com.example.myfirstapplication.outils.MySQLiteOpenHelper;
import java.util.Date;

public class AccesLocal {

    // proprietes
    private String nomBase="bdMyFirstApp.sqlite";
    ...
    /**
     * recuperation de dernier profol de base de données
     * @return
     */
